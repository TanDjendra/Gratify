...
import com.tan.gratify.expect.openUrl
import com.tan.gratify.ui.theme.typo
import org.jetbrains.compose.resources.stringResource
import gratify.composeapp.generated.resources.Res
import gratify.composeapp.generated.resources.desktop_webview_description
import gratify.composeapp.generated.resources.open_blog_post
...
actual fun PlatformWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.gratify.org/blogs/en/how-to-log-in-on-desktop-app")
                },
            ) {
                Text(
...
actual fun DiscordWebView(
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    openUrl("https://www.gratify.org/blogs/en/how-to-log-in-to-Discord-on-desktop-app")
                },
            ) {
                Text(
                    stringResource(Res.string.open_blog_post),
