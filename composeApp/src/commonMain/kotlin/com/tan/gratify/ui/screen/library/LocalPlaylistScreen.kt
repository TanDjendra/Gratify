...
import com.tan.gratify.ui.component.DraggableItem
import com.tan.gratify.ui.component.EndOfPage
import com.tan.gratify.ui.component.LoadingDialog
import com.tan.gratify.ui.component.LocalPlaylistBottomSheet
...
import com.tan.gratify.ui.component.SortPlaylistBottomSheet
import com.tan.gratify.ui.component.SuggestItems
...
import com.tan.gratify.ui.component.rememberDragDropState
...
import gratify.composeapp.generated.resources.baseline_tips_and_updates_24
import gratify.composeapp.generated.resources.cancel
import gratify.composeapp.generated.resources.created_at
...
import gratify.composeapp.generated.resources.reload
import gratify.composeapp.generated.resources.sort_by
import gratify.composeapp.generated.resources.suggest
import gratify.composeapp.generated.resources.sync_playlist_warning
import gratify.composeapp.generated.resources.synced_playlist_cannot_change_order
import gratify.composeapp.generated.resources.unsync_playlist_warning
import gratify.composeapp.generated.resources.warning
import gratify.composeapp.generated.resources.yes
import gratify.composeapp.generated.resources.your_playlist
                                ...
                                Box(modifier = Modifier.fillMaxSize().layerBackdrop(artworkBackdrop)) {
                                    if (isAutoAssignedOrNullThumbnail(uiState.thumbnail, uiState.ytPlaylistId) && uiState.top4Tracks.isNotEmpty()) {
                                        PlaylistCollageThumbnail(
                                            tracks = uiState.top4Tracks,
                                            placeholderTitle = uiState.title,
                                    ...
                                    Column(
                                        ...
                                        if (uiState.creatorName?.isNotBlank() == true) {
                                            Text(
                                                text = "Dibuat oleh ${uiState.creatorName}",
                                                style = typo().titleSmall,
                                                color = Color.White,
                                                textAlign = TextAlign.Center,
                                            )
                                            if (uiState.addCount > 0) {
                                                Spacer(modifier = Modifier.height(2.dp))
                                                Text(
                                                    text = "Ditambahkan ${uiState.addCount} kali",
                            ...
                            Column(Modifier.padding(horizontal = 32.dp)) {
                                ...
                                if (uiState.isUnavailable) {
                                    Box(
                                        ...
                                        Text(
                                            text = "Playlist ini sudah tidak tersedia",
                                ...
                                if (isMobilePortrait) {
                                        ...
                                        Box(
                                            modifier =
                                                Modifier
                                                    .size(48.dp)
                                                    .clip(CircleShape)
                                                    .background(Color.White.copy(alpha = if (uiState.isUnavailable) 0.05f else 0.12f))
                                                    .then(if (!uiState.isUnavailable) Modifier.clickable {
                                            ...
                                            Icon(
                                                ...
                                                tint = Color.White.copy(alpha = if (uiState.isUnavailable) 0.3f else 1f),
                                        ...
                                        Box(
                                            modifier =
                                                Modifier
                                                    ...
                                                    .widthIn(min = 110.dp)
                                                    .clip(CircleShape)
                                                    .background(if (uiState.isUnavailable) Color.White.copy(alpha = 0.3f) else Color.White)
                                                    .then(if (!uiState.isUnavailable) Modifier.clickable {
                                                        if (isThisPlaying) {
                                    ...
                                    Row(
                                        ...
                                        RippleIconButton(
                                            modifier =
                                                Modifier.size(36.dp).then(
                                                    if (uiState.isUnavailable) Modifier.alpha(0.3f) else Modifier
                                                ),
