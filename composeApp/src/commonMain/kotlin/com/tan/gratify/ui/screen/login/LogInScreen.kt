...
import com.tan.gratify.expect.ui.PlatformWebView
import com.tan.gratify.expect.ui.createWebViewCookieManager
import com.tan.gratify.expect.ui.rememberWebViewState
import com.tan.gratify.ui.component.DevLogInBottomSheet
import com.tan.gratify.ui.component.DevLogInType
...
import gratify.composeapp.generated.resources.log_in
import gratify.composeapp.generated.resources.login_failed
import gratify.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.tan.gratify.expect.ui.WebViewState.Finished -> "Finished"
                        is com.tan.gratify.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
