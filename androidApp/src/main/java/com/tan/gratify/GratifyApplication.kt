...
import com.tan.gratify.service.backup.AutoBackupScheduler
...
import com.tan.gratify.crashlytics.configCrashlytics
import java.lang.reflect.Field

class GratifyApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@GratifyApplication)
    ...
    override fun newImageLoader(context: PlatformContext): ImageLoader =
        ImageLoader
            ...
            // Batasi cache gambar di RAM (bitmap). Default Coil ~20% RAM app; di HP 4GB
            // itu bisa puluhan MB. 64MB cukup buat album art — sisanya tetap aman di
            // disk cache 512MB di bawah (reload dari disk cepat).
            .memoryCache {
                MemoryCache.Builder()
