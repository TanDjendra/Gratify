...
import com.tan.gratifymusic.service.backup.AutoBackupScheduler
...
import org.gratifymusic.crashlytics.configCrashlytics
import java.lang.reflect.Field

class GratifyMusicApplication :
    Application(),
    KoinComponent,
    ...
    override fun onCreate() {
        ...
        startKoin {
            ...
            androidContext(this@GratifyMusicApplication)
            loadAllModules()
