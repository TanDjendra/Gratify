...
import com.tan.ktorext.crypto.Hmac
import com.tan.ktorext.crypto.HmacUri
...
import com.tan.gratify.lyrics.models.response.BaseResponse
import com.tan.gratify.lyrics.models.response.BetterLyricsResponse
import com.tan.gratify.lyrics.models.response.LrclibObject
...
private const val TAG = "GratifyLyricsClient"

class GratifyLyricsClient {
    private val algorithm = ""

    private val hmacService = Hmac("HmacSHA256", "gratify-lyrics")
    private val lyricsService = GratifyLyrics()
    ...
    suspend fun getLyrics(
        ...
        runCatching {
            lyricsService.findLyricsByVideoId(
                videoId = videoId,
                track = track,
                artist = artist,
                album = album,
                duration = duration,
            ).bodyOrThrow<List<LyricsResponse>>()
        }
