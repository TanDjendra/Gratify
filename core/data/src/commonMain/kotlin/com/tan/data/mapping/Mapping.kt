package com.tan.data.mapping

import com.tan.data.parser.toListThumbnail
...
internal fun Track.toSongItemForDownload(): SongItem =
    SongItem(
        ...
        artists =
            this.artists?.map {
                com.tan.kotlinytmusicscraper.models.Artist(
                    id = it.id ?: "",
                    name = it.name,
                )
            } ?: emptyList(),
        album =
            com.tan.kotlinytmusicscraper.models.Album(
                id = this.album?.id ?: "",
...
internal fun SearchSuggestions.toDomainSearchSuggestions(): com.tan.domain.data.model.searchResult.SearchSuggestions =
    com.tan.domain.data.model.searchResult.SearchSuggestions(
...
internal fun AccountInfo.toDomainAccountInfo(): com.tan.domain.data.model.account.AccountInfo =
    com.tan.domain.data.model.account.AccountInfo(
        name = this.name,
        email = this.email,
        pageId = this.pageId,
