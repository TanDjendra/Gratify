...
fun Thumbnail.toThumbnail(): com.tan.domain.data.model.searchResult.songs.Thumbnail =
    com.tan.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.tan.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.tan.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
