package com.tan.domain.extension
...
import com.tan.domain.data.model.cookie.CookieItem
...
fun GenericMediaItem.toSongEntity(): SongEntity =
    SongEntity(
        videoId = this.mediaId.removePrefix(MERGING_DATA_TYPE.VIDEO).removePrefix("Video"),
        albumId = null,
...
fun CookieItem.toNetScapeString(): String =
    "# Netscape HTTP Cookie File\n" +
        "# WebView Generated by the Gratify app\n" +
