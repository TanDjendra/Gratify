package com.tan.media3.exoplayer
...
import com.tan.media3.audio.BiquadFilter
import com.tan.media3.audio.CrossfadeFilterAudioProcessor
import com.tan.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
import com.tan.media3.service.mediasourcefactory.MergingMediaSourceFactory
 ...
 *
 * Architecture mirrors [com.gratifymusic.media_jvm.GstreamerPlayerAdapter]:
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${com.tan.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
